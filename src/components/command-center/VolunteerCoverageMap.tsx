  ...
  useEffect(() => {
    ...
    async function initMap() {
      ...
      try {
        ...
        if (!cancelled) {
          setMapError('Map telemetry is unavailable. Check the Google Maps API key to restore volunteer coverage visuals.');
        }
      }
    }
  ...
  useEffect(() => {
    ...
    async function drawMapLayers() {
      ...
      try {
        ...
        if (!cancelled) {
          setMapError('Volunteer markers could not be rendered right now.');
        }
      }
    }
